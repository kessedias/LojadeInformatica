...
{
    public partial class FormRelVendaSim : Form
    {
        public FormRelVendaSim()
        {
            InitializeComponent();
        }

        private void FormRelVendaSim_Load(object sender, EventArgs e)
        {
        ...
        private void btGerarRelatorio_Click(object sender, EventArgs e)
        {
            ...
            switch (pesquisa)
            {
                case "Nome do Cliente":
                    if (txtCliente.Text != "")
                    {
                        classVendaBindingSource.DataSource = cVenda.RelVendaNomeCli(txtCliente.Text);
                        this.rptvVenda.RefreshReport();
                    }
                    else
                    {
                ...
                case "Nome do Funcionário":
                    ...
                    {
                        classVendaBindingSource.DataSource = cVenda.RelVendaNomeFunc(Convert.ToInt32(cbFuncionario.SelectedValue));
                        this.rptvVenda.RefreshReport();
                    }
                    break;
                ...
                case "Forma de Pagamento":
                    ...
                    {
                        classVendaBindingSource.DataSource = cVenda.RelVendaFormaPag(cbPagamento.SelectedItem.ToString());
                        this.rptvVenda.RefreshReport();
                    }
                    break;
                ...
                case "Valor da Venda":
                    ...
                    {
                        classVendaBindingSource.DataSource = cVenda.RelVendaPreço(Convert.ToDecimal(txtPreco1.Text), Convert.ToDecimal(txtPreco2.Text));
                        this.rptvVenda.RefreshReport();
                    }
                    else
                    {
                ...
                case "Data da Venda":
                    ...
                    {
                        classVendaBindingSource.DataSource = cVenda.RelVendaData(Convert.ToDateTime(dtp1.Text), Convert.ToDateTime(dtp2.Text));
                        this.rptvVenda.RefreshReport();
                    }
                    else
                    {
